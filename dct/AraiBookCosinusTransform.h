#ifndef MEDIENINFO_ARAIBOOKCOSINTRANSFORM_H
#define MEDIENINFO_ARAIBOOKCOSINTRANSFORM_H
...
template<typename T>
class AraiBookCosinusTransform {
public:
...
#endif //MEDIENINFO_ARAIBOOKCOSINTRANSFORM_H